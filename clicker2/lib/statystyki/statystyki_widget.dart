          ...
          child: ListView(
            ...
            children: [
                ...
                children: [
                  ...
                  Align(
                    ...
                    child: Padding(
                      padding: EdgeInsetsDirectional.fromSTEB(0, 30, 0, 0),
                      child: Text(
                        FFAppState().ectsclicked.toString(),
                        style: FlutterFlowTheme.of(context).bodyText1.override(
                              fontFamily: 'Poppins',
                              fontSize: 20,
                            ),
                ...
                children: [
                  ...
                  Align(
                    ...
                    child: Padding(
                      padding: EdgeInsetsDirectional.fromSTEB(0, 30, 0, 0),
                      child: Text(
                        FFAppState().iloscnadgodzin.toString(),
                        style: FlutterFlowTheme.of(context).bodyText1.override(
                              fontFamily: 'Poppins',
                              fontSize: 20,
                            ),
                ...
                children: [
                  ...
                  Align(
                    ...
                    child: Padding(
                      padding: EdgeInsetsDirectional.fromSTEB(0, 30, 0, 0),
                      child: Text(
                        FFAppState().osobywkadrze.toString(),
                        style: FlutterFlowTheme.of(context).bodyText1.override(
                              fontFamily: 'Poppins',
                              fontSize: 20,
                            ),
                ...
                children: [
                  ...
                  Align(
                    ...
                    child: Padding(
                      padding: EdgeInsetsDirectional.fromSTEB(0, 30, 0, 0),
                      child: Text(
                        FFAppState().ilosculepszen.toString(),
                        style: FlutterFlowTheme.of(context).bodyText1.override(
                              fontFamily: 'Poppins',
                              fontSize: 20,
                            ),
                ...
                children: [
                  ...
                  Align(
                    ...
                    child: Padding(
                      padding: EdgeInsetsDirectional.fromSTEB(0, 30, 0, 0),
                      child: Text(
                        FFAppState().iloscodrodzen.toString(),
                        style: FlutterFlowTheme.of(context).bodyText1.override(
                              fontFamily: 'Poppins',
                              fontSize: 20,
                            ),
              ...
              Row(
                ...
                children: [
                  Padding(
                    padding: EdgeInsetsDirectional.fromSTEB(90, 10, 0, 0),
                    child: FFButtonWidget(
                      onPressed: () async {
                        apiResultm7t = await WyslijWynikCall.call(
                          title: textController1!.text,
                          liczba: textController2!.text,
                        );
                        if ((apiResultm7t?.succeeded ?? true)) {
                          await showDialog(
                            context: context,
                  ...
                  child: Row(
                    ...
                    children: [
                      Align(
                        ...
                        child: Padding(
                          padding:
                              EdgeInsetsDirectional.fromSTEB(240, 50, 0, 0),
                          child: FFButtonWidget(
                            onPressed: () async {
